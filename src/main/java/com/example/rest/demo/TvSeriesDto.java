...
public class TvSeriesDto {
    ...
    public List<TvCharacterDto> getTvCharacterDtos() {
        return tvCharacterDtos;
    }

    public void setTvCharacterDtos(List<TvCharacterDto> tvCharacterDtos) {
        this.tvCharacterDtos = tvCharacterDtos;
    }
